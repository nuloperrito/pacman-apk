...
extension AndroidPermissionList on AndroidPermission {
  ...
  Icon get icon {switch (this) {
    case AndroidPermission.NONE: return const Icon(MdiIcons.setNone);
    case AndroidPermission.X_ADMIN_BRICK: return const Icon(MdiIcons.bugOutline);
    case AndroidPermission.X_ADMIN_LOCK: return const Icon(MdiIcons.shieldLockOutline);
    case AndroidPermission.ADMIN: return const Icon(MdiIcons.shieldAccountOutline);
    case AndroidPermission.STORAGE: return const Icon(MdiIcons.folderOutline);
    case AndroidPermission.MICROPHONE: return const Icon(MdiIcons.microphoneOutline);
    case AndroidPermission.CAMERA: return const Icon(MdiIcons.cameraOutline);
    case AndroidPermission.LOCATION: return const Icon(MdiIcons.mapMarkerOutline);
    case AndroidPermission.PHONE: return const Icon(MdiIcons.phoneOutline);
    case AndroidPermission.CALL_LOG: return const Icon(MdiIcons.phoneLogOutline);
    case AndroidPermission.SMS: return const Icon(MdiIcons.messageProcessingOutline);
    case AndroidPermission.CONTACTS: return const Icon(MdiIcons.contactsOutline);
    case AndroidPermission.CALENDAR: return const Icon(MdiIcons.calendarMonthOutline);
    case AndroidPermission.ACTIVITY_RECOGNITION: return const Icon(MdiIcons.run);
    case AndroidPermission.X_SENSORS_BODY: return const Icon(MdiIcons.heartSettingsOutline);
    case AndroidPermission.SENSORS: return const Icon(MdiIcons.fingerprint);
    case AndroidPermission.NEARBY_DEVICES: return const Icon(MdiIcons.accessPointNetwork);
    case AndroidPermission.READ_PACKAGES: return const Icon(MdiIcons.package);
  }}
  ...
  String description(AppLocalizations lang) {switch (this) {
    ...
    case AndroidPermission.READ_PACKAGES: return lang.android_permission_read_packages;
  }}
  ...
  static final _permissions = {
    ...
    "android.permission.QUERY_ALL_PACKAGES": AndroidPermission.READ_PACKAGES,
    "android.permission.GET_PACKAGE_SIZE": AndroidPermission.READ_PACKAGES,
  };
}