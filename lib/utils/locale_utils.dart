...
export 'package:pacman_apk/l10n/app_localizations.dart';
...
class WidgetLocalizationOverrides extends DefaultWidgetsLocalizations {
  const WidgetLocalizationOverrides();

  @override
  TextDirection get textDirection => TextDirection.ltr; // Corrected return type from Locale to TextDirection

  static const LocalizationsDelegate<WidgetsLocalizations> delegate = 
      _WidgetLocalizationOverridesDelegate();
}

class _WidgetLocalizationOverridesDelegate extends LocalizationsDelegate<WidgetsLocalizations> {
  const _WidgetLocalizationOverridesDelegate();
  ...
  Future<WidgetsLocalizations> load(Locale locale) async {
    return const WidgetLocalizationOverrides();
  }

  @override
  bool shouldReload(_WidgetLocalizationOverridesDelegate old) => false;
}
